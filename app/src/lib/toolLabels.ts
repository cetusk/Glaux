...
const LABELS: Record<string, ToolLabel> = {
  ...
  import_ir: { short: "響き(IR)を読み込む", doing: "響きを読み込んでいます" },
  ...
  // 音色
  list_presets: { short: "音色のプリセット一覧", doing: "音色のプリセットを探しています" },
  save_preset: { short: "音色のプリセットを保存", doing: "音色のプリセットを保存しています" },
  load_preset: { short: "音色のプリセットを適用", doing: "音色のプリセットを読み込んでいます" },
  delete_preset: { short: "音色のプリセットを削除", doing: "音色のプリセットを削除しています" },
  list_effect_presets: { short: "エフェクトのプリセット一覧", doing: "エフェクトのプリセットを探しています" },
  save_effect_preset: { short: "エフェクトのプリセットを保存", doing: "エフェクトのプリセットを保存しています" },
  load_effect_preset: { short: "エフェクトのプリセットを追加", doing: "エフェクトのプリセットを足しています" },
  delete_effect_preset: { short: "エフェクトのプリセットを削除", doing: "エフェクトのプリセットを削除しています" },
