...
- **Instruments and effects** — 7 built-in instruments (subtractive, FM, wavetable, drums, plucked string, sampler, SoundFont), 11 effects (EQ, compressor, multiband compressor, transient shaper, reverb, amp, and more), and CLAP plugins (e.g. Surge XT)
