...
4. **音作り拡張フェーズ 1(ジャンル表現力: EDM / メタル)**
   - **ディストーション/サチュレーション**エフェクト(ギターの歪み、EDM の質感の要)
   - **サイドチェインコンプ**(EDM のポンピング/ビートダウン)
     ← トラック間ルーティングが必要。設計論点: Effect にサイドチェイン入力のトラック ID を
     持たせるか、エンジンにバス構造を入れるか
   - subtractive 拡張: ユニゾン/デチューン(supersaw)、第 2 オシレータ、ノイズミックス
   - drum 拡張: リバースクラッシュ、EDM 向けの重いキックチューニング
