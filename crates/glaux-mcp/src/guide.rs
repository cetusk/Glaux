...
- 自由なピッチの動き(ゆっくりしたチョーキング・ダイブ・うねり)はノートの pitch_curve([{tick, cents}]。tick はノート先頭からの相対、\n\
  100 cents = 半音、最大 8 点)。",
    ...
    (
        "mix",
        "ミックスとエフェクト",
        "- エフェクト: add_effect(eq / dynamic_eq / resonance / compressor / multiband / transient / limiter / width / reverb / convolution(import_ir で) / distortion / amp / sidechain / delay / chorus / tape)→\n\
