...
- **音源とエフェクト** — 内蔵シンセ 7 種(シンセ・FM・ウェーブテーブル・ドラム・撥弦・サンプラー・SoundFont)、エフェクト 16 種(EQ・ダイナミック EQ・共鳴抑制・コンプ・マルチバンドコンプ・トランジェントシェイパー・リミッタ・ステレオの幅・リバーブ・畳み込みリバーブ・アンプなど)、CLAP プラグイン(Surge XT など)
